...
namespace SHAutomation.Core
{
    public abstract partial class FrameworkAutomationElementBase : FrameworkAutomationElementBase.IProperties
    {
        ...
        private AutomationProperty<SHAutomationElement[]> _controllerFor;
        private AutomationProperty<ControlType> _controlType;
        private AutomationProperty<CultureInfo> _culture;
        private AutomationProperty<SHAutomationElement[]> _describedBy;
        private AutomationProperty<int> _fillColor;
        private AutomationProperty<int> _fillType;
        private AutomationProperty<SHAutomationElement[]> _flowsFrom;
        private AutomationProperty<SHAutomationElement[]> _flowsTo;
        ...
        private AutomationProperty<SHAutomationElement> _labeledBy;
        ...
        /// Gets a string containing the accelerator key combinations for the element.
        /// </summary>
        public AutomationProperty<string> Value => GetOrCreate(ref _value, PropertyIdLibrary.Value);
        ...
        /// </summary>
        public AutomationProperty<SHAutomationElement[]> ControllerFor => GetOrCreate(ref _controllerFor, PropertyIdLibrary.ControllerFor);
        ...
        /// </summary>
        public AutomationProperty<SHAutomationElement[]> DescribedBy => GetOrCreate(ref _describedBy, PropertyIdLibrary.DescribedBy);
        ...
        /// </summary>
        public AutomationProperty<SHAutomationElement[]> FlowsFrom => GetOrCreate(ref _flowsFrom, PropertyIdLibrary.FlowsFrom);

        /// <summary>
        /// Gets an array of elements that suggests the reading order after the current element.
        /// </summary>
        public AutomationProperty<SHAutomationElement[]> FlowsTo => GetOrCreate(ref _flowsTo, PropertyIdLibrary.FlowsTo);
        ...
        /// </summary>
        public AutomationProperty<SHAutomationElement> LabeledBy => GetOrCreate(ref _labeledBy, PropertyIdLibrary.LabeledBy);
