...
namespace SHAutomation.Core.AutomationElements
{
    ...
    /// </summary>
    public class Grid :SHAutomationElement
    {
        ...
        /// </summary>
        public SHAutomationElement[] ColumnHeaders => TablePattern.ColumnHeaders.Value;

        /// <summary>
        /// Gets all row header elements.
        /// </summary>
        public SHAutomationElement[] RowHeaders => TablePattern.RowHeaders.Value;
    ...
    /// </summary>
    public class GridHeader :SHAutomationElement
    {
    ...
    /// </summary>
    public class GridHeaderItem :SHAutomationElement
    {
    ...
    /// </summary>
    public class GridCell :SHAutomationElement
    {
