...
namespace SHAutomation.Core.AutomationElements.Scrolling
{
    /// <summary>
    ...
    public class HorizontalScrollBar : ScrollBarBase
    {
        ...
        {
            SmallDecrementButton.Click(Enums.MouseAction.LeftClick);
        }
        ...
        {
            SmallIncrementButton.Click(Enums.MouseAction.LeftClick);
        }
