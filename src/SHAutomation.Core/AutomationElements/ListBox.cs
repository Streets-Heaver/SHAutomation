...
namespace SHAutomation.Core.AutomationElements
{
    ...
    /// </summary>
    public class ListBox :SHAutomationElement
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns the items which are currently visible to SHAutomation. Might not be the full list (eg. in WPF virtualized lists)!
        /// </summary>
