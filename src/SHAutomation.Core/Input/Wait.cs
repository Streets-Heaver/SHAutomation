...
namespace SHAutomation.Core.Input
{
    /// <summary>
    ...
    public static class Wait
    {
        ...
        public static bool UntilResponsive(SHAutomationElement sHAutomationElement)
        {
            return UntilResponsive(sHAutomationElement, DefaultTimeout);
        }
