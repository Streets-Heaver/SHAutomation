...
namespace SHAutomation.Core.Patterns
{
    public interface IDragPattern : IPattern
    {
        ...
        AutomationProperty<SHAutomationElement[]> GrabbedItems { get; }
    }
        ...
        where TNativePattern : class
    {
        ...
        private AutomationProperty<SHAutomationElement[]> _grabbedItems;
        ...
        public AutomationProperty<SHAutomationElement[]> GrabbedItems => GetOrCreate(ref _grabbedItems, PropertyIds.GrabbedItems);
    }
}
